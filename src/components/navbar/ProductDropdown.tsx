...
const ProductDropdown = () => {
  return (
    <div className="absolute left-0 mt-2 w-screen max-w-full md:max-w-[650px] bg-white text-black rounded-md shadow-lg p-4 md:p-6 flex flex-col md:flex-row gap-6 z-50">
      ...
      {/* Right Column */}
      <div className="w-full md:w-1/3 text-sm text-gray-800 space-y-3 border-t md:border-t-0 md:border-l md:pl-6 border-gray-200 pt-4 md:pt-0">
